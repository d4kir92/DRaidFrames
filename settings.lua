...
function DRaidFrames:InitSettings()
	DRFTAB = DRFTAB or {}
	DRaidFrames:SetVersion(AddonName, 254652, "1.1.14")
	drf_settings = DRaidFrames:CreateFrame(
		{
			...
			["sw"] = 520,
			["sh"] = 520,
			["title"] = format("DRaidFrames |T254652:16:16:0:0|t v|cff3FC7EB%s", "1.1.14")
		}
	)
	...
	DRaidFrames:CreateMinimapButton(
		{
			...
			["icon"] = 254652,
			["dbtab"] = DRFTAB,
			["vTT"] = {{"DRaidFrames |T254652:16:16:0:0|t", "v|cff3FC7EB1.1.14"}, {"Leftclick", "Toggle Settings"}, {"Rightclick", "Hide Minimap Icon"}},
			["funcL"] = function()
